...
?>
    ...
    <div id="link-collection">
        ...
        <input type="number" placeholder="enter app_ID" style="margin-top: 20px; width: 200px; text-align:center;" name="update" class="text"> <br />
        <input type="text" placeholder="dd-mm-yy" style="margin-top: 30px; width: 200px; text-align:center;" name="date" class="text"> <br />
        <br />
        ...
        <input type="text" name="delete" placeholder="enter application number" class="text" style="margin-top: 20px; width: 200px; text-align:center;" >
            <br />
            <br />
